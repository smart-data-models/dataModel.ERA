...
class Type6(Enum):
    SubsetWithCommonCharacteristics = 'SubsetWithCommonCharacteristics'


class SubsetWithCommonCharacteristics(BaseModel):
    ...
    railSystemType: Optional[str] = Field(None, description='Rail system type')
    ...
    subsetName: Optional[str] = Field(
        None, description='Name of a subset with common characteristics'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI data type. It has to be SubsetWithCommonCharacteristics'
    )
